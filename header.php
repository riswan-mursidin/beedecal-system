            ...
            <div class="dropdown d-inline-block user-dropdown">
              ...
              >
                <img
                  ...
                  src="<?= $row['foto_user'] == '' ? 'assets/images/users/avatar-2.png' : $row['foto_user'] ?>"
                  alt="Header Avatar"
                />
                <span class="d-none d-xl-inline-block ms-1"><?= $usernamelogin ?></span>
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a class="dropdown-item" href="edit-password"
                  ><i class="ri-lock-unlock-line align-middle me-1"></i> Edit
                  Password</a
                >
