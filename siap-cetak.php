...
if(isset($_POST['aksi_cetak'])){
  ...
  if($result){
    $insetcetak = "INSERT INTO data_cetakan (code_order,id_percetakan,id_bahan,lebar_bahan,panjang_bahan) VALUES('$spk','$id_percetakan','$id_bahan','$lebar','$panjang')";
          ...
          <div class="modal-dialog modal-dialog-centered">
            <form action="" method="post" class="modal-content">
              ...
              <div class="modal-body">
                <div action="" method="post" class="row g-3">
